...
lazy_static! {
	pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
		...
		OpCode::new(0x5D, "EOR", 3, 4 /* +1 if page boundary crossed */, AddressingMode::Absolute_X),
		OpCode::new(0x59, "EOR", 3, 4 /* +1 if page boundary crossed */, AddressingMode::Absolute_Y),
